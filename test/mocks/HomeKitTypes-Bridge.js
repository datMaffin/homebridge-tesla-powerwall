/*eslint-disable*/
/*
 * Copied from: https://github.com/KhaosT/HAP-NodeJS/blob/master/lib/gen/HomeKitTypes-Bridge.js
 */
'use strict';
// Removed from new HAS

var inherits = require('util').inherits;
var Characteristic = require('./characteristic').Characteristic;	// => changed
var Service = require('./service').Service;							// => changed
